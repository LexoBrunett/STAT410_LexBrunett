  ...
  # Table #1
    (c.table1 <- array(data=c(w1[1], w2[1], n1-w1[1], n2-w2[1]),
                       dim=c(2,2), dimnames=list(Group=c(1,2),
                                                 Response=c(1,2))))

  # Table #5
    (c.table5 <- array(data=c(w1[5], w2[5], n1-w1[5], n2-w2[5]),
                       dim=c(2,2), dimnames=list(Group = c(1,2),
                                                 Response = c(1, 2))))
